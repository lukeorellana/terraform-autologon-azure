 ...
 resource "azurerm_virtual_machine" "vm" {
   ...
   os_profile_windows_config{
     ...
     additional_unattend_config { 
       ...
       content = "<AutoLogon><Enabled>true</Enabled><Username>${var.admin_username}</Username><Password><Value>${var.admin_password}</Value><PlainText>true</PlainText></Password><LogonCount>1</LogonCount></AutoLogon>" 
     } 
   }
